...
class DroneServiceScreen extends StatefulWidget {
  const DroneServiceScreen({super.key});

  @override
  State<DroneServiceScreen> createState() => _DroneServiceScreenState();
}

class _DroneServiceScreenState extends State<DroneServiceScreen> {
  ...
  final List<Map<String, String>> ads = [
    ...
    {'image': 'assets/images/droan.jpg', 'title': 'droneRental'},
  ...
  final List<String> serviceKeys = [
    'serviceLiquidSpraying',
    'serviceGranularSpreading',
    'serviceMapping',
  ];
...
''';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.t('droneServiceBooking')),
      ),
      body: ListView(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            decoration: InputDecoration(labelText: l10n.t('typeOfWork')),
